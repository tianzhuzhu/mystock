...
from baostock import query_cash_flow_data

import database
from data.importBasicInformation import queryDubpontByCode, queryGrowthByCode, queryStockIndustry
...
# data=query_cash_flow_data('sh.600519',2020,1)
